...
route recommendations. Contemporary road signs follow strict design rules to optimise their clarity of
...
Currently there is only one .ipynb file that contains the entire source code. Use Python 3.x.x to run it.

The dataset and labels are already present in ./MyData & ./labels.csv. The code is set up to extract the data from those paths.
