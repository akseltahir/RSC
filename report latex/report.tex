...
implemented closely resembles LeNet (Figure~\ref{fig:figurelenet}), proposed by
Yann LeCun et al in 1998. The dataset we've trained the model upon is the GTSRB.
\begin{figure}[H]
